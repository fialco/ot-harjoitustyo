...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahentaa_saldoa_oikein_kun_rahaa_tarkasti(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_syo_maukkaasti_vahentaa_saldoa_oikein_kun_rahaa_tarkasti(self):
        kortti = Maksukortti(400)
        kortti.syo_maukkaasti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    #Kortilla liian vähän rahaa
    ...
    def test_ladatessa_negatiivinen_summa_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-2500)
